...
<img src="/images/other/LOBSTAHS_TOC_Figure.png" class="small-inline-img">The LOBSTAHS software (Lipid and Oxylipin Biomarker Screening Through Adduct Hierarchy Sequences) is available at [https://github.com/vanmooylipidomics/LOBSTAHS](https://github.com/vanmooylipidomics/LOBSTAHS) and is currently under review at Bioconductor(http://bioconductor.org). The manuscript describing LOBSTAHS has been published in **Analytical Chemistry.** (Links, etc., are on the [Publications](/publications/) page.)
